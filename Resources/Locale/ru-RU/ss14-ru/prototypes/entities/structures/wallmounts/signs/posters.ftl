...
ent-PosterContrabandRise = Восстань
    .desc = Плакат с изображением человека в сером, держащего лом, и надписью "Восстань" внизу.
...
ent-PosterContrabandEnlistGorlex = Вступай!
    .desc = Вступайте в ряды мародёров Горлекса уже сегодня! Повидайте галактику, убивайте корпорации, получайте деньги!
...
ent-PosterLegitAnatomyPoster = Анатомия человека
...
ent-PosterLegitCarpMount = Настенный Карп
    .desc = Карпе диэм!
ent-PosterLegitSafetyMothDelam = Предосторожная Моль - меры предосторожности при расслаивании
    .desc = Этот информационный плакат использует Предосторожную Моль™ , чтобы рассказать читателям о необходимости прятаться в шкафах, когда кристалл суперматерии расслаивается, во избежание галлюцинаций. Лучшей стратегией может быть эвакуация.
ent-PosterLegitSafetyMothEpi = Предосторожная Моль - Эпинефрин
    .desc = Этот информационный плакат использует Предосторожную Моль™ для информирования читателей о необходимости помочь раненым/погибшим членам экипажа с помощью инъекторов с эпинефрином. "Предотвратите гниение органов с помощью одного простого приёма!"
ent-PosterLegitSafetyMothPiping = Предосторожная Моль - Трубопровод
    .desc = Этот информационный плакат использует Предосторожную Моль™, чтобы рассказать атмосферным техникам о правильных типах используемых трубопроводов. "Трубы, а не насосы! Правильное размещение труб предотвращает низкую производительность!"
ent-PosterLegitSafetyMothMeth = Предосторожная Моль - Метамфетамин
    .desc = Этот информационный плакат использует Предосторожную Моль™, чтобы предупредить читателей о необходимости получения разрешения ГВ перед приготовлением метамфетамина. "Держитесь ближе к заданной температуре и никогда не превышайте ее!" ...Вы никогда не должны готовить это.
ent-PosterLegitSafetyMothHardhat = Предосторожная Моль - Каски
    .desc = Этот информационный плакат использует Предосторожную Моль™, чтобы рассказать читателям о необходимости ношения касок в зонах повышенной опасности. "Это как лампа для головы!"
...
ent-PosterLegitRenault = Плакат Алисы
    .desc = Яп.
ent-PosterLegitNTTGC = Карты Тактической Игры Nanotrasen
