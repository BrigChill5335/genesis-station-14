...
ui-options-overlay-merge-distance = Дистанция объединения стаков
ui-options-overlay-ghost-fade-distance = Дистанция затемнения оверлея призрака от курсора
ui-options-overlay-ghost-hide-distance = Дистанция скрытия оверлея призрака от курсора
