...
handcuff-component-start-cuffing-observer = { $user } начинает надевать наручники на { $target }!
...
handcuff-component-cuff-observer-success-message = { $user } надевает наручники на { $target }.
