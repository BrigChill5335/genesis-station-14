...
using Content.Shared.Crawling; // Genesis-Edit
...
{
    [Dependency] private readonly CrawlingSystem _crawlingSystem = default!; // Genesis-Edit
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<LegsParalyzedComponent, CrawlStandupDoAfterEvent>(OnCrawlStandup); // Genesis-Edit
        SubscribeLocalEvent<LegsParalyzedComponent, CrawlingKeybindEvent>(OnCrawlKeybind); // Genesis-Edit
    }
